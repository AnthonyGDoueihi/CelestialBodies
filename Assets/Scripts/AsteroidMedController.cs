...
public class AsteroidMedController : MonoBehaviour {
    ...
    private void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            Instantiate(smallAsteroidPrefab, transform.position, Quaternion.identity, sceneCon.transform);
            Instantiate(smallAsteroidPrefab, transform.position, Quaternion.identity, sceneCon.transform);
            sceneCon.AddScore(15);
